...
public class PerformanceComparisonSortedDes {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < size1.length; i++) size1[i] = size1.length - i;
        for (int i = 0; i < size2.length; i++) size2[i] = size2.length - i;
        for (int i = 0; i < size3.length; i++) size3[i] = size3.length - i;
